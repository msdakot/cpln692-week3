...
console.log('Using underscore function, generate a list of all bike share docks that are greater than 20.',largeStationList);

var largeStationCount = _.countBy(data,
  function(obj){
    return obj[3]>20 ? 'Greater than 20:':"Lesser than 20:";
  });

console.log('Using underscore function, total count of the docks that are greater than 20.',largeStationCount);
